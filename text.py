fr_text = dict(
    ...
    address = "Comment?! {name}? Ahhhh, oui, je me souviens de cette adresse! \
C'est: {address}",

    # Your sentence must contains {story} and {story_title}
    story = "Mais t'ai-je déjà raconté l'histoire de ce quartier qui m'a vu \
    en culottes courtes ? {story_title}: {story}",
